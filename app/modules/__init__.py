...
from app.modules.base import DataSource, AnalysisModule, UploadModule
...
__all__ = [
    ...
    'FlightAnalysis',
    'PlateSearchAnalysis',
    'SpatialPenetrationAnalysis',
    'RentalAnalysis',
    'LodgingQueryAnalysis',
    'CohabitAnalysis',
    'HotelPenetrationAnalysis',
    'PlateVerificationAnalysis',
]
